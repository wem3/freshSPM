...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{'/Volumes/data/studyname/random/resultsdir/spmT_0001.nii'}};
matlabbatch{2}.cfg_basicio.file_dir.file_ops.cfg_named_file.name = 'image_to_reslice';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{'/Volumes/data/templates/canon/MNI152_T1_1mm_brain.nii'}};
...
matlabbatch{3}.spm.spatial.coreg.write.roptions.prefix = 'funk_sliced_';
